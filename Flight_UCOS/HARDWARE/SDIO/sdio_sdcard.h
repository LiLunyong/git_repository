...
// ��,����Ҳ�����?1?7,�������뽵��ʱ��
#define SDIO_INIT_CLK_DIV 0x76	   // SDIO��ʼ��Ƶ�ʣ����?1?7400Kh
#define SDIO_TRANSFER_CLK_DIV 0x00 // SDIO����Ƶ��,��ֵ̫С���ܻᵼ�¶�д�ļ�����

////////////////////////////////////////////////////////////////////////////////////////////////////
// SDIO����ģʽ����,ͨ��SD_SetDeviceMode��������.
#define SD_POLLING_MODE 0 // ��ѯģʽ,��ģʽ��,�����д������?1?7,��������SDIO_TRANSFER_CLK_DIV������.
#define SD_DMA_MODE 1	  // DMAģʽ,��ģʽ��,�����д������?1?7,��������SDIO_TRANSFER_CLK_DIV������.
...
typedef struct
{
	SD_CSD SD_csd;
	SD_CID SD_cid;
	long long CardCapacity; // SD������,��λ:�ֽ�,���֧��?1?72^64�ֽڴ�С�Ŀ�.
	u32 CardBlockSize;		// SD������?1?7
	u16 RCA;				// ����Ե��?1?7
	u8 CardType;			// ������
} SD_CardInfo;
